/*!
 * Sixp JavaScript Library v1.0. IE version.
 *
 ...
 */
//
// IE version. Use ExplorerCanvas.
// 1. addEventListener -> attachEvent
// 2. e.pageX -> this.pageX(e)
// 3. in event handlers, this.offsetLeft/Top -> me.vSelectCanvas.offsetLeft/Top
// 4. onmouseout is unreliable for IE, use onmouseleave, or just remove it.
// 5. drawGameOverMsg(): In IE, Use sans-serif instead of Helvetica. IE will have error "glyphs is null or not an object".
//    IE explorercanvas also does not support Chinese, so can not draw chinese characters too. Do relevent replacement.
// 6. to recognize left/right mouse button in IE, use event.button instead of event.which.
// 7. set explosionSteps to 10 instead of 20. So it's faster in IE.
// 8. set CIRCLE_MOVE_STEP to 10 instead of 20. So it's faster in IE.
// 
...
if (typeof (Chess6p) == "undefined") {
    ...
    var Chess6p = function() {
        ...
        this.doExplosion;
        this.doExplosionPos = [];
        this.explosionSteps = 10; // less for IE, so it's faster.
        ...
        this.CIRCLE_MOVE_STEP = 10; // how many intermediate states to draw when moving a piece.
        ...
        var p = this;
        window.attachEvent('onresize', function(e) { p.updateSelectCanvasPosition(e, p); }, true);
    ...
    Chess6p.prototype.drawGameOverMsg = function(fontSize) {
        ...
        context.save();
        // Shadow is not supported in excanvas.
    ...
    //
    Chess6p.prototype.pageX = function(e) {
    ...
    Chess6p.prototype.pageY = function(e) {
    ...
    Chess6p.prototype.getLoc = function(e) {
        ...
        return " [x,y]:[" + (this.pageX(e) - this.vBoard.offsetLeft) + "," +
                      (this.pageY(e) - this.vBoard.offsetTop) + "]";
    }
    ...
    Chess6p.prototype.initSelectEventListener = function(me) {
        me.vSelectCanvas.attachEvent('onmousedown', function(e) {
            ...
            var mouse_x = me.pageX(e) - me.vSelectCanvas.offsetLeft,
                mouse_y = me.pageY(e) - me.vSelectCanvas.offsetTop;
        ...
        me.vSelectCanvas.attachEvent('ontouchstart', function(e) {
            if (e.touches.length == 1) {
                e.preventDefault();
                var mouse_x = e.touches[0].pageX - me.vSelectCanvas.offsetLeft,
                    mouse_y = e.touches[0].pageY - me.vSelectCanvas.offsetTop;
        ...
        me.vSelectCanvas.attachEvent('ontouchmove', function(e) {
            // don't capture event if is moving circle now.
            if (me.inMovingCircle) { return; }

            if (e.touches.length == 1) {
                e.preventDefault();
                me.mouse_x = e.touches[0].pageX - me.vSelectCanvas.offsetLeft;
                me.mouse_y = e.touches[0].pageY - me.vSelectCanvas.offsetTop;
        ...
        me.vSelectCanvas.attachEvent('onmouseup', function(e) {
            ...
            if (me.vSelect) {
                ...
                var mouse_x0 = me.pageX(e) - me.vSelectCanvas.offsetLeft,
                    mouse_y0 = me.pageY(e) - me.vSelectCanvas.offsetTop;
                me.moveCircle(mouse_x0, mouse_y0);
            }
        }, false);

        me.vSelectCanvas.attachEvent('ontouchend', function(e) {
            if (me.vSelect) {
        ...
        me.vSelectCanvas.attachEvent('onmouseleave', function(e) {
